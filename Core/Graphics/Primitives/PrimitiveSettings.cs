...
{
    public record PrimitiveSettings(VertexWidthFunction WidthFunction, VertexColorFunction ColorFunction, VertexOffsetFunction OffsetFunction = null, bool Smoothen = true, bool Pixelate = false, MiscShaderData Shader = null, (Vector2 Left, Vector2 Right)? InitialVertexPositionsOverride = null)
    {
        /// <summary>
